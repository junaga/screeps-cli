...
import { coordinate, pageNumber, parseTarget, playerName, positiveNumber, roomName, roomPosition } from '../src/validation.js'

test('validates game coordinates, pages, and positive numbers', () => {
