...
The game begins from your appearance on the map. You can choose any room with a neutral Controller and at least one energy source, although we recommend to choose a room with two sources and inside one of the [Start Areas](https://docs.screeps.com/start-areas.html). So, after analyzing the landscape, place your spawn on the map:

![](https://docs.screeps.com/img/CreateSpawn.png)

Now the room is in [Safe mode](https://docs.screeps.com/defense.html) during **20,000 game ticks** (approx. 15** **hours depending on the tick duration). Use this period to explore the room, develop, plan defenses, and prepare for capturing territory and resources.
...
As you have already known from the article [Control](https://docs.screeps.com/control.html), a player's **Global Control Level** (GCL) remains the same after the Respawn. So, if you have a right to claim 3 rooms, you will never lose it.
