...
In order to safely test your scripts in a parallel copy of the world, you can use our [Public Test Realm](https://docs.screeps.com/ptr.html) server.
...
![](https://docs.screeps.com/img/chrome_2016-06-21_22-21-36.png)
