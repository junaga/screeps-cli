...
we've already compiled the [`addTwo.wasm`](https://docs.screeps.com/img/addTwo.wasm) file for you from the example below.
...
![](https://docs.screeps.com/img/binary3.png)
