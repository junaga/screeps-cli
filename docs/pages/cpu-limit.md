...
The property [`Game.cpu.tickLimit`](https://docs.screeps.com/api/#Game.cpu) reflects the amount of CPU that you can spend on a current tick given the accumulation. As soon as the [`Game.cpu.bucket`](https://docs.screeps.com/api/#Game.cpu) is full, [`Game.cpu.tickLimit`](https://docs.screeps.com/api/#Game.cpu) equals 500. It will start decreasing only after the accumulation is depleted. [`Game.cpu.tickLimit`](https://docs.screeps.com/api/#Game.cpu) can never be less than your account limit, i.e the [`Game.cpu.limit`](https://docs.screeps.com/api/#Game.cpu) property.
